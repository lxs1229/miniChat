...
$GLOBALS["MINICHAT_I18N"] = [
    "fr" => [
        ...
        "game_2048_h1" => "2048",
        "game_2048_rules" => "Flèches/WASD pour jouer • Entrée pour recommencer • Shift+Entrée = rien",
        ...
        "game_ms_rules" => "Clic gauche : révéler • Clic droit : drapeau • Double clic : ouvrir autour",
    ...
    "en" => [
        ...
        "game_2048_badge" => "MiniChat • 2048",
        "game_2048_h1" => "2048",
        "game_2048_rules" => "Arrow keys/WASD • Enter to restart",
        ...
        "game_ms_badge" => "MiniChat • Minesweeper",
        "game_ms_h1" => "Minesweeper",
        "game_ms_rules" => "Left click: reveal • Right click: flag • Double click: open around",
    ...
    "zh" => [
        ...
        "game_2048_badge" => "MiniChat • 2048",
        "game_2048_h1" => "2048",
        "game_2048_rules" => "方向键/WASD 操作 • Enter 重新开始",
        "game_2048_new" => "新游戏",
        ...
        "game_ms_h1" => "扫雷",
        "game_ms_rules" => "左键：打开 • 右键：插旗 • 双击：打开周围",
        "game_ms_new" => "新游戏",
